...
public class MySQLStorage
    ...
    public MySQLStorage(BuyerManager manager) {
    ...
    public void init() {
        ...
        config.setJdbcUrl("jdbc:mysql://" + manager.getCfg().getHost() + ":" + manager.getCfg().getPort() + "/" + this.manager.getCfg().getDatabase() + "?useSSL=false&autoReconnect=true&characterEncoding=utf8");
        config.setUsername(manager.getCfg().getUsername());
        config.setPassword(manager.getCfg().getPassword());
